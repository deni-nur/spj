...
// form open
echo form_open_multipart(base_url('user/edit/'.$user->user_id));
?>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group <?=form_error('level_id') ? 'has-error' : null ?>">
                                ...
                                <select name="level_id" class="form-control" >
                                    ...
                                    <?php foreach($level->result() as $key => $data) { ?>
                                        <option value="<?=$data->level_id ?>" <?=$data->level_id==$user->level_id ? "selected" : null ?>><?=$data->level?></option>
                                    <?php } ?>
                                </select>
                                <?=form_error('level_id') ?>
                            </div>
                            <div class="form-group <?=form_error('is_active') ? 'has-error' : null ?>">
                                ...
                                <select name="is_active" class="form-control">
                                    ...
                                    <option value="0" <?php if($user->is_active==0) { echo "selected"; } ?>>Non Aktif</option>
                                </select>
                            ...
                            <div class="form-group <?=form_error('tahun_anggaran_id') ? 'has-error' : null ?>">
                                ...
                                <select name="tahun_anggaran_id" class="form-control" >
                                    ...
                                    <?php foreach($tahun_anggaran->result() as $key => $data) { ?>
                                        <option value="<?=$data->tahun_anggaran_id ?>" <?=$data->tahun_anggaran_id==$user->tahun_anggaran_id ? "selected" : null ?>><?=$data->tahun ?></option>
                                    <?php } ?>
                                </select>
