...
// form open
echo form_open(base_url('kwitansi/'.$this->uri->segment(2).'/belanja/'.$this->uri->segment(4).'/add'),' class="form-horizontal"');
?>
    ...
    <div class="row">
      <div class="col-md-4 col-md-offset-4">
          ...
          <div class=" input-group">
              ...
              <input type="hidden" name="npd_id" id="npd_id" class="form-control" required>
