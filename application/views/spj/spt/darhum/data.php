	...
	<div class="box">
		<div class="box-header">
			...
			<div class="pull-right">
				<a href="<?=site_url('darhum/add') ?>" class="btn btn-success">
          ...
          foreach($darhum->result() as $key => $data) { ?>
              <tr>
                  ...
                  <td class="text-center" width="60px">
                      <a href="<?=site_url('darhum/edit/'.$data->darhum_id) ?>" class="btn btn-warning btn-sm">
                          <i class="fa fa-pencil" title="Update"></i>
                      </a>
                      <a href="#" class="btn btn-danger btn-sm delete-button" data-toggle="modal" data-target="#deleteModal" data-id="<?php echo $data->darhum_id; ?>">
...
<script>
    $(document).on("click", ".delete-button", function () {
        var id = $(this).data('id');
        $('#confirmDelete').attr('href', '<?php echo site_url('darhum/del_darhum/') ?>' + id);
    });
</script>
