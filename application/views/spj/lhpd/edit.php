...
// form open
echo form_open_multipart(base_url('lhpd/edit/'.$lhpd->lhpd_id),' class="form-horizontal"');
?>
            ...
            <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group date">
                            ...
                            <input type="date" name="tanggal_lhpd" value="<?=$lhpd->tanggal_lhpd ?>" class="form-control" required>
                            </div>
                        </div>
                    <div>
                    <div class="form-group">
                        <label>Maksud Perjalanan Dinas *</label>
                        <input type="hidden" name="surat_tugas_id" value="<?=$lhpd->surat_tugas_id ?>" id="surat_tugas_id">
                        <textarea name="maksud" id="maksud" rows="5" class="form-control" required readonly><?=$lhpd->maksud ?></textarea>
                    ...
                    <label>Hari *</label>
                        <select name="hari" class="form-control" required>
                            ...
                            <option value="Senin" <?php if($lhpd->hari=="Senin") { echo "selected"; } ?>>Senin</option>
                            <option value="Selasa" <?php if($lhpd->hari=="Selasa") { echo "selected"; } ?>>Selasa</option>
                            <option value="Rabu" <?php if($lhpd->hari=="Rabu") { echo "selected"; } ?>>Rabu</option>
                            <option value="Kamis" <?php if($lhpd->hari=="Kamis") { echo "selected"; } ?>>Kamis </option>
                            <option value="Jumat" <?php if($lhpd->hari=="Jumat") { echo "selected"; } ?>>Jumat</option>
                            <option value="Sabtu" <?php if($lhpd->hari=="Sabtu") { echo "selected"; } ?>>Sabtu</option>
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group date">
                            ...
                            <input type="date" name="tanggal_kegiatan" value="<?=$lhpd->tanggal_kegiatan ?>" class="form-control" required>
                            </div>
                        </div>
                    <div>
                    <div class="form-group">
                        <label>Waktu *</label>
                        <input type="text" name="waktu" value="<?=$lhpd->waktu ?>" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Tempat *</label>
                        <input type="text" name="tempat" value="<?=$lhpd->tempat ?>" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Laporan Hasil Perjalanan Dinas *</label>
                        <textarea name="hasil_kegiatan" rows="7" class="form-control" required><?=$lhpd->hasil_kegiatan ?></textarea>   
                    </div>
