...
// form open
echo form_open(base_url('npd/'.$this->uri->segment(2).'/add'),' class="form-horizontal"');
?>
                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class="form-group">
                        ...
                        <div class="input-group date">
                            ...
                            <input type="date" name="tanggal_npd" value="<?= date('Y-m-d') ?>" class="form-control" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="belanja_id">Nama Belanja *</label>
                        <input type="hidden" name="belanja_id" id="belanja_id">
                        <input type="text" name="nama_sub_rincian_objek" id="nama_sub_rincian_objek" class="form-control" required readonly>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="uraian" id="maksud" class="form-control" required>
                        <input type="hidden" name="surat_tugas_id" id="surat_tugas_id">
                        <input type="hidden" name="pengikut_id" id="pengikut_id">
                        <span class="input-group-btn btn-group-vertical">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" name="sppd_id" id="sppd_id">
                        <input type="text" name="tempat_tujuan" id="tempat_tujuan" class="form-control" readonly>
                    </div>
                    <div class="form-group">
                        <label for="lama_perjalanan">Kuantitas *</label>
                        <input type="text" name="lama_perjalanan" value="1" id="lama_perjalanan" class="form-control" readonly required>
                    </div>
                    <div class="form-group">
                        <label for="no_rekening">Nomor Rekening *</label>
                        <input type="hidden" name="rekening_id" id="rekening_id">
                        <input type="text" name="no_rekening" id="no_rekening" class="form-control" required autofocus readonly>
                        <span class="input-group-btn btn-group-vertical">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="pemilik" id="pemilik" class="form-control" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="pajak" value="0" id="pajak" class="form-control">
                    </div>
