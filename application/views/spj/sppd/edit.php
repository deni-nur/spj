...
// form open
echo form_open(base_url('sppd/edit/'.$sppd->sppd_id),' class="form-horizontal"');
?>
        ...
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
              <div class="form-group">
                  ...
                  <input type="hidden" name="surat_tugas_id" value="<?=$sppd->surat_tugas_id ?>" id="surat_tugas_id">
                    <textarea name="maksud" id="maksud" rows="5" class="form-control" required readonly><?=$sppd->maksud ?></textarea>
              ...
              <label>Tingkat Biaya</label>
                <select name="tingkat_biaya" class="form-control" required>
                  ...
                  <option value="APBD" <?php if($sppd->tingkat_biaya=="APBD") { echo "selected"; } ?>> APBD</option>
                  <option value="APBN" <?php if($sppd->tingkat_biaya=="APBN") { echo "selected"; } ?>> APBN</option>
                </select>
              </div>
              ...
              <label>Alat Angkutan</label>
                  <select name="alat_angkutan" class="form-control" required>
                    <option value="">- Pilih -</option>
                    <option value="Motor" <?php if($sppd->alat_angkutan=="Motor") { echo "selected"; } ?>> Motor</option>
                    <option value="Mobil" <?php if($sppd->alat_angkutan=="Mobil") { echo "selected"; } ?>> Mobil</option>
                    <option value="Bus" <?php if($sppd->alat_angkutan=="Bus") { echo "selected"; } ?>> Bus</option>
                  </select>
                </div>
              <div>
              ...
              <div class="form-group input-group">
                  <input type="hidden" name="kecamatan_id" id="kecamatan_id" value="<?=$sppd->kecamatan_id ?>">
                  <input type="hidden" name="provinsi_id" id="provinsi_id" value="<?=$sppd->provinsi_id ?>">
                  <input type="text" name="tempat_tujuan" id="tempat_tujuan" value="<?=$sppd->tempat_tujuan ?>" class="form-control" required readonly>
              ...
              <label>Lama Perjalanan Dinas</label>
                  <select name="lama_perjalanan" class="form-control" required>
                      <option value="">- Pilih -</option>
                      <option value="1" <?php if($sppd->lama_perjalanan=="1") { echo "selected"; } ?>> 1</option>
                      <option value="2" <?php if($sppd->lama_perjalanan=="2") { echo "selected"; } ?>> 2</option>
                      <option value="3" <?php if($sppd->lama_perjalanan=="3") { echo "selected"; } ?>> 3</option>
                      <option value="4" <?php if($sppd->lama_perjalanan=="4") { echo "selected"; } ?>> 4</option>
                      <option value="5" <?php if($sppd->lama_perjalanan=="5") { echo "selected"; } ?>> 5</option>
                      <option value="6" <?php if($sppd->lama_perjalanan=="6") { echo "selected"; } ?>> 6</option>
                      <option value="7" <?php if($sppd->lama_perjalanan=="7") { echo "selected"; } ?>> 7</option>
                  </select>
                </div>
                <div class="form-group">
                    <label>Tanggal Berangkat *</label>
                       <input type="date" name="tanggal_berangkat" value="<?=$sppd->tanggal_berangkat ?>" class="form-control" >
                </div>
                <div class="form-group">
                    <label>Tanggal Pulang *</label>
                       <input type="date" name="tanggal_pulang" value="<?=$sppd->tanggal_pulang ?>" class="form-control" >
                </div>
              <div>
              <label for="nama_rek">Rincian Belanja *</label>
              </div>
              <div class="form-group input-group">
                  <input type="hidden" name="belanja_id" value="<?=$sppd->belanja_id ?>" id="belanja_id">
                  <input type="text" name="nama_rek" id="nama_rek" value="<?=$sppd->nama_sub_rincian_objek ?>" class="form-control" required readonly>
                  <span class="input-group-btn">
              ...
              <div class="form-group">
                  ...
                  <select name="ttd_keuangan_id" class="form-control" required>
                      ...
                      <?php foreach ($ttd_keuangan->result() as $key => $data) { ?>
                        <option value="<?=$data->ttd_keuangan_id ?>" <?=$data->ttd_keuangan_id == $sppd->ttd_keuangan_id ? "selected" : null ?>><?=$data->name ?></option>
                      <?php } ?>
                  </select>
              </div>
