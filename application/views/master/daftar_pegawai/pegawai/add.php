...
// form open
echo form_open(base_url('pegawai/add'),' class="form-horizontal"');
?>
						...
						<div class="form-group">
							...
							<select name="pangkat_id" class="form-control" >
								...
								<?php foreach($pangkat->result() as $key => $data) { ?>
									<option value="<?=$data->pangkat_id?>"><?=$data->pangkat?>, <?=$data->golongan ?></option>
								<?php } ?>
							</select>
						</div>
						<div class="form-group">
							...
							<select name="jabatan_id" class="form-control" required>
								...
								<?php foreach($jabatan->result() as $key => $data) { ?>
									<option value="<?=$data->jabatan_id?>"><?=$data->jabatan ?></option>
								<?php } ?>
							</select>
						</div>
