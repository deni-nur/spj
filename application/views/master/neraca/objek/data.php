...
<section class="content">
	...
	<div class="box">
		<div class="box-header">
			...
			<div class="pull-right">
				<a href="<?=site_url('objek/add') ?>" class="btn btn-success">
					...
					<?php $no =1;
                        ...
                        <tr>
                            ...
                            <td class="text-center" width="160px">
                                <a href="<?=site_url('objek/edit/'.$data->objek_id) ?>" class="btn btn-warning btn-xs">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="modal-danger" method="post" action="<?=site_url('objek/del_objek') ?>">
      <div class="modal-footer">
        <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Tidak</button>
        <button type="hidden" name="objek_id" value="<?=$data->objek_id ?>" class="btn btn-outline">Ya</button>
      </div>
      </form>
    </div>
  </div>
