...
<section class="content">
	...
	<div class="box">
		<div class="box-header">
			...
			<div class="pull-right">
				<a href="<?=site_url('kecamatan/add') ?>" class="btn btn-success">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="modal-danger" method="post" action="<?=site_url('kecamatan/del_kecamatan') ?>">
      <div class="modal-footer">
        <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Tidak</button>
        <button type="hidden" name="kecamatan_id" value="<?=$data->kecamatan_id ?>" class="btn btn-outline">Ya</button>
      </div>
      </form>
    </div>
  </div>
