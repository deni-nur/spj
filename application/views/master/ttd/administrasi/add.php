...
// form open
echo form_open_multipart(base_url('ttd_administrasi/add'),' class="form-horizontal"');
?>
	...
	<div class="box">
		...
		<div class="box-body">
	        ...
	        <br>
	        	...
	        	<input type="text" name="jabatan_ttd_administrasi" class="form-control" placeholder="Boleh di KOSONGKAN">
	        </div>
	        <div class="form-group">
