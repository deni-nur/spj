...
// form open
echo form_open(base_url('dpa/edit/'.$dpa->dpa_id),' class="form-horizontal"');
?>
            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    ...
                    <label for="kode">Kode Sub Kegiatan *</label>
                        <input type="text" name="kode" value="<?=$dpa->kode ?>" id="kode" class="form-control" required readonly>
                    </div>

                    <div class="form-group">
                        <label for="sub_kegiatan">Sub Kegiatan *</label>
                        <input type="hidden" name="kegiatan_id" id="kegiatan_id">
                        <textarea name="name" id="name" rows="5" class="form-control" required autofocus readonly><?=$dpa->name ?></textarea>
