...
// form open
echo form_open(base_url('unit_kerja/edit/'.$unit_kerja->unit_kerja_id));
?>
            ...
            <div class="row">
                <div class="col-md-12">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" name="unit_kerja" value="<?=$unit_kerja->unit_kerja ?>" class="form-control" required>
                        </div>
