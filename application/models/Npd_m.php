...
class Npd_m extends CI_Model {
	...
	GROUP BY
	    sub_rincian_objek.kode_sub_rincian_objek, npd.uraian, npd.biaya, npd.tanggal_npd, akun.kode_akun, kelompok.kode_kelompok, jenis.kode_jenis, objek.kode_objek, rincian_objek.kode_rincian_objek, sub_rincian_objek.nama_sub_rincian_objek, belanja.pagu_belanja_murni, belanja.belanja_id;
	    ";
